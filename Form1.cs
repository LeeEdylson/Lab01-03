...
namespace Lab01_Form01HW
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            temp.Add("1", "Convertir de °C a °F");
            temp.Add("2", "Convertir de °F a °C");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (op == "/")
                resultado.Text = Convert.ToString(res1);
            else
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string temp = (string)comboBox2.SelectedValue; 
            switch (temp)
            {
                case "1":
        ...
        private void dvgraz_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
